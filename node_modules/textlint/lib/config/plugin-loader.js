...
var _textlintModuleMapper = require("../engine/textlint-module-mapper");

var _textlintModuleMapper2 = _interopRequireDefault(_textlintModuleMapper);
...
function mapRulesConfig(rulesConfig, pluginName) {
    ...
    return _textlintModuleMapper2.default.createMappedObject(rulesConfig, pluginName);
}
