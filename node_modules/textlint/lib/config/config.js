...
var _engineTextlintModuleResolver = require("../engine/textlint-module-resolver");

var _engineTextlintModuleResolver2 = _interopRequireDefault(_engineTextlintModuleResolver);
...
function separateAvailableOrDisable(rulesConfig) {
    ...
    Object.keys(rulesConfig).forEach(function (key) {
        ...
        if ((0, _utilConfigUtil.isPresetRuleKey)(key)) {
        ...
        if ((0, _utilConfigUtil.isPluginRuleKey)(key)) {
            return;
        }
        // ignore `false` value
        if (typeof rulesConfig[key] === "object" || rulesConfig[key] === true) {
...
var Config = (function () {
    ...
    function Config() {
        ...
        var moduleResolver = new _engineTextlintModuleResolver2["default"](this.constructor, this.rulesBaseDirectory);
        ...
        var pluginRulesConfig = (0, _pluginLoader2["default"])(this.plugins, moduleResolver);
