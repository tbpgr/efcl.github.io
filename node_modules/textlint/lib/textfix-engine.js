...
var _engineTextlintEngineCore = require("./engine/textlint-engine-core");

var _engineTextlintEngineCore2 = _interopRequireDefault(_engineTextlintEngineCore);

var _fixerTextfixFormatter = require("./fixer/textfix-formatter");

var _fixerTextfixFormatter2 = _interopRequireDefault(_fixerTextfixFormatter);
...
function TextFixEngine(config) {
    ...
    var executor = {
        ...
        onFormat: function onFormat(formatterConfig) {
            ...
            return (0, _fixerTextfixFormatter2["default"])(formatterConfig);
        }
    };
    return new _engineTextlintEngineCore2["default"](config, executor);
};
