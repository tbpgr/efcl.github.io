...
var _configConfigInitializer = require("./config/config-initializer");

var _configConfigInitializer2 = _interopRequireDefault(_configConfigInitializer);
...
var cli = {
    ...
    execute: function execute(args, text) {
        ...
        if (currentOptions.version) {
            ...
            return _configConfigInitializer2["default"].initializeConfig(process.cwd());
        } else if (currentOptions.help || !files.length && !text) {
            _utilLogger2["default"].log(_options2["default"].generateHelp());
        } else {
    ...
    executeWithOptions: function executeWithOptions(cliOptions, files, text, stdinFilename) {
        var config = _configConfig2["default"].initWithCLIOptions(cliOptions);
            ...
            var _ret = (function () {
                ...
                return {
                    v: resultsPromise.then(function (results) {
                        var fixer = new _fixerTextlintFixer2["default"]();
