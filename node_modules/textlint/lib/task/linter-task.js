...
var _coreRuleContext = require("../core/rule-context");

var _coreRuleContext2 = _interopRequireDefault(_coreRuleContext);

var _utilTiming = require("./../util/timing");

var _utilTiming2 = _interopRequireDefault(_utilTiming);

var _coreRuleCreatorHelper = require("../core/rule-creator-helper");
    ...
    _createClass(TextLintCoreTask, [{
        ...
        value: function _setupRuleCreatorListener() {
            ...
            Object.keys(rules).forEach(function (key) {
                ...
                try {
                    var ruleContext = new _coreRuleContext2["default"](key, sourceCode, report, textLintConfig, ruleConfig);
                    var ruleObject = (0, _coreRuleCreatorHelper.getLinter)(ruleCreator)(ruleContext, ruleConfig);
