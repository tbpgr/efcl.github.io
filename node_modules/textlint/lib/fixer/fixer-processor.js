...
var _fixerSourceCodeFixer = require("../fixer/source-code-fixer");

var _fixerSourceCodeFixer2 = _interopRequireDefault(_fixerSourceCodeFixer);

var _taskTaskRunner = require("../task/task-runner");

var _taskTaskRunner2 = _interopRequireDefault(_taskTaskRunner);
        ...
        value: function process(_ref) {
            ...
            var fixerProcessList = ruleCreatorSet.mapFixer(function (fixerRuleCreatorSet) {
                return function (sourceText) {
                    ...
                    var newSourceCode = new _coreSourceCode2["default"]({
                        text: sourceText,
                    ...
                    return _taskTaskRunner2["default"].process(task).then(function (messages) {
                        ...
                        var applied = _fixerSourceCodeFixer2["default"].applyFixes(newSourceCode, result.messages);
                        // add messages
