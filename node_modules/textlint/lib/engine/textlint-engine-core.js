...
var _ruleMap = require("./rule-map");

var _ruleMap2 = _interopRequireDefault(_ruleMap);

var _processorMap = require("./processor-map");

var _processorMap2 = _interopRequireDefault(_processorMap);

var _config = require("../config/config");

var _config2 = _interopRequireDefault(_config);

var _findUtil = require("../util/find-util");

var _textlintModuleLoader = require("./textlint-module-loader");

var _textlintModuleLoader2 = _interopRequireDefault(_textlintModuleLoader);
...
var TextLintEngineCore = function () {
    ...
    function TextLintEngineCore(options) {
         ...
         */
        this.config = null;
        if (options instanceof _config2.default) {
            // Almost internal use-case
            this.config = options;
        } else {
            this.config = _config2.default.initWithAutoLoading(options);
        }
         ...
         */
        this.ruleMap = new _ruleMap2.default();
        /**
         * @type {RuleMap} filerRuleMap is used for filtering
         */
        this.filterRuleMap = new _ruleMap2.default();
        /**
         * @type {ProcessorMap}
         */
        this.processorMap = new _processorMap2.default();
        this.moduleLoader = new _textlintModuleLoader2.default(this.config);
        this.moduleLoader.on(_textlintModuleLoader2.default.Event.rule, function (_ref) {
            var _ref2 = _slicedToArray(_ref, 2);

            var ruleName = _ref2[0];
            var ruleCreator = _ref2[1];

            _this.ruleMap.defineRule(ruleName, ruleCreator);
        });
        this.moduleLoader.on(_textlintModuleLoader2.default.Event.filterRule, function (_ref3) {
            var _ref4 = _slicedToArray(_ref3, 2);

            var ruleName = _ref4[0];
            var ruleCreator = _ref4[1];

            _this.filterRuleMap.defineRule(ruleName, ruleCreator);
        });
        this.moduleLoader.on(_textlintModuleLoader2.default.Event.processor, function (_ref5) {
            var _ref6 = _slicedToArray(_ref5, 2);

            var pluginName = _ref6[0];
            var Processor = _ref6[1];
    ...
    _createClass(TextLintEngineCore, [{
        ...
        value: function executeOnFiles(files) {
            ...
            var targetFiles = (0, _findUtil.findFiles)(files, this.availableExtensions);
        ...
        value: function isErrorMessage(message) {
            return message.severity === _SeverityLevel2.default.error;
        }
