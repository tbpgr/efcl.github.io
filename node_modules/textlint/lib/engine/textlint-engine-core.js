...
var TextLintEngineCore = (function () {
    ...
    function TextLintEngineCore(options) {
         ...
         */
        this.config = null;
        if (options instanceof _configConfig2["default"]) {
            // Almost internal use-case
            this.config = options;
        } else {
            this.config = _configConfig2["default"].initWithAutoLoading(options);
        }
        ...
        this.moduleLoader.on(_textlintModuleLoader2["default"].Event.processor, function (_ref3) {
            var _ref32 = _slicedToArray(_ref3, 2);

            var pluginName = _ref32[0];
            var Processor = _ref32[1];
    ...
    _createClass(TextLintEngineCore, [{
        ...
        value: function executeOnText(text) {
            ...
            var execText = typeof this.executor.onText === "function" ? this.executor.onText(this.textlint) : boundLintText;
            // filePath or ext
        ...
        value: function isErrorMessage(message) {
            return message.severity === _sharedRuleSeverity.SeverityLevel.error;
        }
